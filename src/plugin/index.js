// 插件对应组件的名字
import stationPicker from './station-picker-rzt';
...
stationPicker.install = Vue => Vue.component(stationPicker.name, stationPicker);//注册组件
// 标签的方式引入，留到后面再另开新篇讨论
const install = function(Vue, opts = {}) {
    Vue.component(stationPicker.name, stationPicker);
}
